...
def union(s1,t1,s2,t2):
    ...
    addEdge(su, epssymbol, s1)
    addEdge(su, epssymbol, s2)
    addEdge(t1, epssymbol, tu)
    addEdge(t2, epssymbol, tu)
...
def clo(s,t):
    ...
    addEdge(sc, epssymbol, s)
    addEdge(sc, epssymbol, tc)
    addEdge(t, epssymbol, s)
    addEdge(t, epssymbol, tc)
